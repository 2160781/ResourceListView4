...
public class DadosApp {
    ...
    public DadosApp() {
        ...
        receita.add(new PassoReceita("Passo 2", "R.drawable.ingredientesbolo"));
        receita.add(new PassoReceita("Passo 3", ""));
        receita.add(new PassoReceita("Passo 4", ""));
        receita.add(new PassoReceita("Passo 5", ""));
